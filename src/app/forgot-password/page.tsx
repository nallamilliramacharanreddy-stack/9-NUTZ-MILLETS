...
import { Mail, ArrowLeft, Loader2, AlertCircle, CheckCircle2, Key } from "lucide-react";
      ...
      <div className="container mx-auto px-4 flex-grow flex items-center justify-center">
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400 text-sm mt-2">Enter your email to receive a 6-digit OTP code.</p>
          </div>
          ...
          {!success ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {loading ? <Loader2 className="animate-spin" size={20} /> : <span>Send OTP Code</span>}
              </button>
            </form>
          ) : (
            <div className="space-y-6">
               <div className="p-6 bg-emerald-50 text-emerald-700 rounded-3xl text-sm flex flex-col items-center text-center space-y-4 border border-emerald-100">
                  ...
                  <div>
                    <p className="font-bold text-lg">OTP Sent Successfully!</p>
                    <p className="text-emerald-600/80 mt-1">Please check your email <b>{email}</b> for the 6-digit code.</p>
                  </div>
                  ...
                  <p className="text-[10px] uppercase tracking-widest font-bold opacity-50">Redirecting to verification page...</p>
               </div>
            </div>
          )}
          ...
          <div className="mt-10 text-center">
            <Link href="/login" className="text-sm font-bold text-brand-green hover:text-brand-gold flex items-center justify-center space-x-2">
              <ArrowLeft size={16} />
